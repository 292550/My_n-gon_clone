const tech = {
    ...
    },
    {
        ...
        frequencyDefault: 1,
        allowed() {
            return (tech.haveGunCheck("laser") || tech.isLaserMine || tech.isLaserBotUpgrade || tech.isLaserField) && !tech.isPulseLaser
        },
    ...
    },
    {
        ...
        frequencyDefault: 2,
        allowed() {
            return tech.haveGunCheck("laser") && tech.laserReflections < 10 && !tech.isPulseLaser 
        },
    ...
    },
    {
        ...
        effect() {
            ...
            tech.laserColor = "transparent" //"rgb(255,0,20,0.2)"
